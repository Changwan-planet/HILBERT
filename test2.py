...
plt.plot(data3_2.loc[:,0], 'b')
plt.grid()

plt.subplot(612)
plt.plot(data_2.loc[:,0],'b')
plt.plot(data3_2.loc[:,0],'g')
plt.grid()


plt.subplot(613)
plt.plot(data_2.loc[:,1], 'r')


plt.subplot(614)
plt.plot(data4_2.loc[:,0], 'r')
plt.plot(data4_2.loc[:,1], 'b')
plt.grid()

plt.subplot(615)
plt.plot(data5_2.loc[:,0],'b')
plt.plot(data5_2.loc[:,1],'g')
plt.grid()

plt.subplot(616)
plt.plot(data6_2.loc[:,0], 'r')
plt.plot(data6_2.loc[:,1],'g')
plt.grid()
